...
public class LoseScreen implements GLEventListener {
    ...
    public void init(GLAutoDrawable glad) {
        ...
        // Inicialize o TextRenderer para renderizar o texto
    ...
    private void renderText(GLAutoDrawable glad) {
        ...
        // Comece a renderizar o texto
        textRenderer.beginRendering(width, height);
        textRenderer.setColor(1.0f, 1.0f, 1.0f, 1.0f); // Cor vermelha para o texto

        // Definir posição do texto
        int textX = width / 2 - 100;
        int textY = height / 3;

        // Exibir as mensagens de controle
        textRenderer.draw("Press X to Exit", textX, textY + 30);  // Press X to Exit
        textRenderer.draw("Press R to Play Again", textX, textY - 30);  // Press R to Play Again

        // Finalize a renderização
